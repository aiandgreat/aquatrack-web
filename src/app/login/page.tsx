...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans">
        ...
        <div className="relative z-10 flex flex-col h-full p-10 md:p-12 min-h-[600px] md:min-h-screen">
          ...
          <div className="mb-10">
            ...
            <p className="text-sm text-white/45 mt-3 leading-relaxed max-w-sm font-medium">
              Unified command platform for real-time water infrastructure monitoring, AI-powered triage, and field operations coordination.
            </p>
          </div>
      ...
      {/* ── RIGHT PANEL ─────────────────────────────────────────────── */}
      <div className="relative w-full md:w-[58%] flex items-center justify-center p-8 md:p-16 overflow-hidden bg-white">
        ...
        <motion.div
          ...
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-3xl font-black text-[#001e66] tracking-tight">Welcome back</h2>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10"
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label htmlFor="login-email" className="block text-[10px] font-black uppercase tracking-[0.12em] text-slate-400">
                  Email Address
                </label>
                <input
                  id="login-email"
              ...
              {/* Password */}
              <div className="space-y-1.5">
                <label htmlFor="login-password" className="block text-[10px] font-black uppercase tracking-[0.12em] text-slate-400">
                  Password
                </label>
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••••"
                    className="w-full px-4 py-3.5 pr-12 rounded-xl border border-slate-200 bg-slate-50 text-[#001e66] font-semibold text-sm placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-[#00aeef]/25 focus:border-[#00aeef] transition-all"
                  />
              ...
              <button
                ...
                type="submit"
                disabled={loading}
                className="w-full text-white font-black py-4 rounded-xl transition-all duration-200 text-[11px] uppercase tracking-[0.15em] mt-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
